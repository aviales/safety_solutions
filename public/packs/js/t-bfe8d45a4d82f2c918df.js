...
(function (c) {
  c.fn.t = function (k, J) {
    return this.each(function () {
      ...
      !e(d) && (d = g.shift());
      g.push("\u200B");
      "de" == a.locale && (z = "12qwertzuiop\xFC+asdfghjkl\xF6\xE4#<yxcvbnm,.-!\"\xA7$%&/(()=?1234567890\xDF*p+");
      var K = F() + 1;
      !t && e(a.init, "f") && a.init(r);
      r.data("ti", I = setInterval(function () {
        m = r;
        if (++B >= m.data("speed") / 10) if (B = 0, m.data("paused")) y = 1;else if (!p) {
          p = !p;
          ...
          for (;;) {
            if (!0 === m.data().beep && f.beep(), b.append(d), H && a.typing(m, d, F(), K), !/<ins.*?>[\s\S]+</.test(d) && /></.test(d) && (b = b.find(":last")), (_ss = b.data("speed")) && m.s(_ss), g[0] && /<\w+/.test(g[0])) d = g.shift();else break;
          }
...
/******/ });
//# sourceMappingURL=t-bfe8d45a4d82f2c918df.js.map